...
namespace AutoMapper.EquivilencyExpression
{
        ...
        where TDestination : class
    {
        ...
        private Func<TSource, TDestination, bool> _equivilantExpressionFunc;
        ...
        public EquivilentExpression(Expression<Func<TSource,TDestination,bool>> equivilentExpression)
        {
            ...
            _equivilantExpressionFunc = _equivilentExpression.Compile();
        }
        ...
        public bool IsEquivlent(object source, object destination)
        {
            ...
            return _equivilantExpressionFunc(source as TSource, destination as TDestination);
        }
